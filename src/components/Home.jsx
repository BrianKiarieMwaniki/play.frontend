      ...
      <div>
        ...
        <ul>
          <li>
            ...
            <a href="https://docs.microsoft.com/en-us/dotnet/csharp">C#</a> for
            cross-platform server-side code
          </li>
          <li>
            <a href="https://www.docker.com">Docker</a> for services
            containerization
          </li>
          <li>
            <a href="https://www.mongodb.com">MongoDB</a> for database storage
          </li>
          <li>
            <a href="https://www.rabbitmq.com">RabbitMQ</a> and{" "}
            <a href="https://masstransit-project.com">MassTransit</a> for
